...
async function uploadVideo() {
    ...
    const promise = await new Promise<void>((resolve, reject) => {
        ...
        xhr.open('POST', 'http://api.demomyfairpipe.com/video/upload')
...
async function uploadThumbnail(id: number) {
    ...
    const promise = new Promise<void>((resolve, reject) => {
        ...
        xhr.open('POST', 'http://api.demomyfairpipe.com/thumbnail/upload')
        xhr.withCredentials = true
        xhr.send(formData)
        xhr.DONE
    })
...
async function uploadSubtitle(id: number) {
    ...
    const res = await fetch('http://api.demomyfairpipe.com/subtitles/upload', {
        method: 'POST',
        body: formData,
        credentials: 'include',
    })
