 ...
 */
onMounted(async () => {
    const req = await fetch(`http://api.demomyfairpipe.com/user/get`, {
        credentials: 'include',
    });
...
function loadProfile() {
    ...
    xhr.open('GET', 'http://api.demomyfairpipe.com/user/get', true);
...
function loadProfilePicture() {
    const xhr = new XMLHttpRequest();
    xhr.open('GET', 'http://api.demomyfairpipe.com/user/picture/get', true);
    xhr.withCredentials = true;
...
function applyChanges() {
    uploadPfp();
    const xhr = new XMLHttpRequest();
    xhr.open('PATCH', 'http://api.demomyfairpipe.com/user/update', true);
    xhr.withCredentials = true;
...
async function uploadPfp() {
    const xhr = new XMLHttpRequest();
    xhr.open('POST', 'http://api.demomyfairpipe.com/user/picture/upload', true);
    xhr.withCredentials = true;
