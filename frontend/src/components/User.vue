...
async function logout() {
    await fetch(`http://api.demomyfairpipe.com/auth/logout`, {
        method: 'POST',
        credentials: 'include',
    })
...
onMounted(async () => {
    const req = await fetch(`http://api.demomyfairpipe.com/user/get?_=${Date.now()}`, {
        credentials: 'include',
        cache: 'no-store',
    })
...
async function loadProfile() {
    try {
        const res = await fetch(`http://api.demomyfairpipe.com/user/get?_=${Date.now()}`, {
            method: 'GET',
            credentials: 'include',
            cache: 'no-store',
        })
...
async function loadProfilePicture() {
    try {
        const res = await fetch('http://api.demomyfairpipe.com/user/picture/get', {
            method: 'GET',
            credentials: 'include',
            cache: 'no-store',
        })
